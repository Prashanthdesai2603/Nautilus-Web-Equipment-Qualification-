...
export async function generateDim1Section({
    report,
    data,
    chartImage,
    addPageHeader,
    ...
    report.regData("Dim1DB", "Dim1DB", { Dim1Table: tableData });
    ...
    if (chartImage) {
        ...
        chartLabel.text = "Tonnage Dim1 Chart";
    ...
    const columns = ["Tonnage", "Sample 1", "Sample 2", "Sample 3", "Avg Dim 1", "Actual Increase", "% Increase"];
    ...
    dataBand.dataSourceName = "Dim1Table";
