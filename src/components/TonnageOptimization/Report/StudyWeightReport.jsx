...
export async function generateStudyWeightSection({
    report,
    data,
    chartImage,
    addPageHeader,
    ...
    // 1. Filter valid rows and map to objects for cleaner binding
    ...
    // 2. Register Data using standard JSON objects (Highly reliable in Stimulsoft JS)
    report.regData("StudyWeightDB", "StudyWeightDB", { StudyWeightTable: tableData });
    ...
    if (chartImage) {
        ...
        chartLabel.text = "Tonnage Study Weight Chart";
    ...
    const columns = ["Tonnage", "Sample 1", "Sample 2", "Sample 3", "Average Weight", "Actual Increase", "% Increase"];
    ...
    dataBand.dataSourceName = "StudyWeightTable";
